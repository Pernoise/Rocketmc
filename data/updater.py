...
def update():
    if not check_network():
        return
    repo_latest = "https://github.com/CesarGarza55/RocketMC/releases/latest"
    try:
        ...
        if latest_version > actual_version:
            ...
            if messagebox.askyesno("Update", lang(current_language, "update_available")):
                ...
                if sys.platform == "win32":
                    url = f"{repo_latest}/download/RocketMC.exe"
                    ...
                    if format_choice == 'bin':
                        url = f"{repo_latest}/download/RocketMC.bin"
                        ...
                        url = f"{repo_latest}/download/RocketMC.deb"
