...
languages = {
    "en": {
        ...
        "launcher_name": "RocketMC",
        "launcher_title": "RocketMC for Minecraft",
        "label_username": "Welcome to RocketMC\nEnter your username",
        ...
        "welcome": "Welcome to RocketMC!",
        "welcome_message": (
            "RocketMC is a free and open-source launcher for Minecraft that allows you to install and play the version you want, "
            ...
            f"Visit the <a style='color: #00aaff;' href='{variables.website_url}'>RocketMC website</a> for more information.<br><br>"
            "RocketMC offers some features like:"
            "<ul>"
        ...
        "shortcuts_info": (
            ...
            f"Use the following format: 'RocketMC{platform} -mc_ver 1.0 -mc_name Steve', where '1.0' is the Minecraft version and 'Steve' is the username. "
            f"For more information, visit the <a style='color: #00aaff;' href='{variables.website_url}/guide'>RocketMC documentation</a>.<br><br>"
            "Example of a shortcut to launch the game with version 1.0 and username Steve:<br>"
            f"<b>'RocketMC{platform} -mc_ver 1.0 -mc_name Steve'</b><br><br>"
            f"Use <b>'RocketMC{platform} -h'</b> to see the available parameters."
        ),
        ...
        "no_refresh_token": "You must be logged in to use the online mode, please run RocketMC without arguments to open the GUI and log in",
        "no_version": "No version has been selected, please run RocketMC -mc_ver <version> -mc_name <username> -online <true/false> to run Minecraft",
        "mc_fail": "An error occurred while trying to run Minecraft please run RocketMC without arguments to open the GUI",
    ...
    "es": {
        ...
        "launcher_name": "RocketMC",
        "launcher_title": "RocketMC para Minecraft",
        "label_username": "Bienvenido a RocketMC\nIngresa tu nombre de usuario",
        ...
        "get_started": "Inicio",
        "welcome": "¡Bienvenido a RocketMC!",
        "welcome_message": (
            "RocketMC es un lanzador gratuito y de código abierto para Minecraft que te permite instalar y jugar la versión que desees, "
            ...
            f"Visita el <a style='color: #00aaff;' href='{variables.website_url}'>sitio web de RocketMC</a> para obtener más información.<br><br>"
            "RocketMC ofrece algunas características como:"
            "<ul>"
        ...
        "logged_as": "Bienvenido a RocketMC\n\nConectado como",
        ...
        "shortcuts_info": (
            ...
            f"Usa el siguiente formato: 'RocketMC{platform} -mc_ver 1.0 -mc_name Steve', donde '1.0' es la versión de Minecraft y 'Steve' es el nombre de usuario. "
            f"Para más información, visita la <a style='color: #00aaff;' href='{variables.website_url}/guide'>documentación de RocketMC</a>.<br><br>"
            "Ejemplo de acceso directo para lanzar el juego con la versión 1.0 y el nombre de usuario Steve:<br>"
            f"<b>'RocketMC{platform} -mc_ver 1.0 -mc_name Steve'</b><br><br>"
            f"Usa <b>'RocketMC{platform} -h'</b> para ver los parámetros disponibles."
        ),
        ...
        "no_refresh_token": "Debes iniciar sesión para usar el modo en línea, por favor ejecuta RocketMC sin argumentos para abrir la GUI e iniciar sesión",
        "no_version": "No se ha seleccionado ninguna versión, por favor ejecuta RocketMC -mc_ver <version> -mc_name <username> -online <true/false> para ejecutar Minecraft",
        "mc_fail": "Ocurrió un error al intentar ejecutar Minecraft por favor ejecuta RocketMC sin argumentos para abrir la GUI",
    ...
    "fr": {
        ...
        "launcher_name": "RocketMC",
        "launcher_title": "RocketMC pour Minecraft",
        "label_username": "Bienvenue sur RocketMC\nEntrez votre nom d'utilisateur",
        ...
        "welcome": "Bienvenue sur RocketMC !",
        "welcome_message": (
            "RocketMC est un lanceur gratuit et open-source pour Minecraft qui vous permet d'installer et de jouer à la version que vous souhaitez, "
            ...
            f"Visitez le <a style='color: #00aaff;' href='{variables.website_url}'>site web RocketMC</a> pour plus d'informations.<br><br>"
            "RocketMC offre quelques fonctionnalités comme :"
            "<ul>"
        ...
        "logged_as": "Bienvenue sur RocketMC\n\nConnecté en tant que",
        ...
        "shortcuts_info": (
            ...
            f"Utilisez le format suivant : 'RocketMC{platform} -mc_ver 1.0 -mc_name Steve', où '1.0' est la version de Minecraft et 'Steve' est le nom d'utilisateur. "
            f"Pour plus d'informations, visitez la <a style='color: #00aaff;' href='{variables.website_url}/guide'>documentation RocketMC</a>.<br><br>"
            "Exemple de raccourci pour lancer le jeu avec la version 1.0 et le nom d'utilisateur Steve :<br>"
            f"<b>'RocketMC{platform} -mc_ver 1.0 -mc_name Steve'</b><br><br>"
            f"Utilisez <b>'RocketMC{platform} -h'</b> pour voir les paramètres disponibles."
        ),
        ...
        "no_refresh_token": "Vous devez être connecté pour utiliser le mode en ligne, veuillez exécuter RocketMC sans arguments pour ouvrir l'interface graphique et vous connecter",
        "no_version": "Aucune version n'a été sélectionnée, veuillez exécuter RocketMC -mc_ver <version> -mc_name <username> -online <true/false> pour exécuter Minecraft",
        "mc_fail": "Une erreur s'est produite lors de l'essai d'exécution de Minecraft, veuillez exécuter RocketMC sans arguments pour ouvrir l'interface graphique",
