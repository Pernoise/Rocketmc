...
!define APPNAME "RocketMC"
!define DESCRIPTION "RocketMC is an open-source Minecraft launcher developed in Python using PyQt5 and the minecraft_launcher_lib library."
...
!define HELPURL "https://github.com/CesarGarza55/RocketMC"
!define UPDATEURL "https://github.com/CesarGarza55/RocketMC/releases/latest/download/RocketMC.exe"
!define ABOUTURL "https://github.com/CesarGarza55/RocketMC"
...
Section "install"
  ...
  CreateShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\RocketMC.exe"
  CreateShortCut "$SMPROGRAMS\${APPNAME}\uninstall.lnk" "$INSTDIR\uninstall.exe"
  CreateShortCut "$DESKTOP\${APPNAME}.lnk" "$INSTDIR\RocketMC.exe"
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${APPNAME}" "DisplayIcon" "$INSTDIR\RocketMC.exe"
